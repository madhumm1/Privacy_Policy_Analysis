...
def dataupload():
	if request.method == 'POST':
		...
		# Use BeautifulSoup to parse the HTML content / web scrapping 
		soup = BeautifulSoup(response.content, "html.parser")
		#print(soup)
		#keywords we took by manually inspecting privacy policy to check with LDA geenrated topic words during Fixed topic modelling, this is to make sure the topics we geenrated are related to privacy
		privacy_keywords=["personal information", "data", "information", "cookies", "IP address",
                  ...
                  "vital interest", "public interest", "right to be forgotten", "right to access", "right to rectification", "right to erasure", 
				  "right to restrict processing", "right to data portability", "right to object", "data protection officer", "breach notification", 
				  "enforcement", "accountability", "privacy policy", "terms of service", "cookie policy", "user agreement", "privacy notice", "data controller",
				  "data processor", "EU-U.S. Privacy Shield", "Safe Harbor", "Privacy Shield", "BCRs", "model clauses", "consent management", 
				  "cookie consent", "privacy settings", "privacy dashboard", "opt-out mechanism", "privacy seal", "trustmark", "information commissioner's office", 
				  "data protection authority", "privacy rights", "data protection", "pseudonymization", 
				  "anonymization","name",'hipaa', 'pipeda', 'coppa',"Demographic Data"]

		#store the paraprapg that we got from web page after scrapping
		privacy_paragraphs = []
		#print("i")
		...
		#here we are converting paragraphs in to sentences
		sentences=[]
		nltk.download('punkt')
		...
		for sentence in sentences:
			...
			#removed stop words from the tokens(words)
